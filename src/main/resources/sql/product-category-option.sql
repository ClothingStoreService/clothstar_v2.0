...
INSERT INTO category (category_type) VALUES ('상의');

alter table product_line modify column sale_count bigint after status;
ALTER TABLE product_line ADD content TEXT AFTER name;
