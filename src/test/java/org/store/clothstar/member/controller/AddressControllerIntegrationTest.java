...
class AddressControllerIntegrationTest {
    ...
    public void getMemberId_getAccessToken() {
        ...
        memberRepository.save(CreateObject.getMemberByCreateMemberRequestDTO(account.getAccountId()));
    ...
    void saveMemberAddrTest() throws Exception {
        //given
        final String url = ADDRESS_URL + accountId;
    ...
    void memberGetAllAddressTest() throws Exception {
        //given
        final String getMemberAddressURL = ADDRESS_URL + accountId;
        for (int i = 0; i < 5; i++) {
            addressServiceImpl.addrSave(accountId, getCreateAddressRequest("서울시 공릉동" + i));
        }
