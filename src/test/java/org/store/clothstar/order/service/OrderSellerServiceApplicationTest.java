...
class OrderSellerServiceApplicationTest {
    ...
    @Mock
    private MybatisOrderSellerRepository mybatisOrderSellerRepository;
...
//
//        //then
//        then(mybatisOrderSellerRepository).should(times(1)).approveOrder(orderId);
...
//
//        //then
//        then(mybatisOrderSellerRepository).should(times(1)).cancelOrder(orderId);
//        then(orderRepository).should(times(2)).getOrder(orderId);
//        assertThat(messageDTO.getStatus()).isEqualTo(HttpStatus.OK.value());
